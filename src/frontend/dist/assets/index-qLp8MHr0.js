...
function ContactSection() {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      label: "GitHub",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Github, { className: "w-5 h-5" })
    },
    {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-24 px-6 pb-32 lg:pb-24 bg-card/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fade-in-up mb-16 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono-code text-xs text-primary tracking-widest uppercase mb-3 block", children: "// restons en contact" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl md:text-5xl font-bold", children: "Me contacter" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-4 text-muted-foreground", children: [
        ...
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "Je lis tout." })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fade-in-up flex justify-center gap-4 mb-12", children: socialLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "a",
      {
        href: link.href,
        target: "_blank",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fade-in-up", children: formState === "success" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        "data-ocid": "contact.success_state",
        className: "flex flex-col items-center gap-4 py-16 text-center",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-16 h-16 text-green-nature" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-2xl font-bold", children: "Message envoyé !" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Je te réponds dès que possible." }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "c-name", children: "Nom" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "c-name",
        ...
        errors.name && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-destructive text-xs", children: errors.name })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        ...
        errors.email && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-destructive text-xs", children: errors.email })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        ...
        errors.message && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-destructive text-xs", children: errors.message })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          children: formState === "loading" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              LoaderCircle,
              {
...
function ExperienceSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "experience", className: "py-24 px-6 bg-card/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fade-in-up mb-16 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono-code text-xs text-green-nature tracking-widest uppercase mb-3 block", children: "// parcours" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl md:text-5xl font-bold", children: "Expérience" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fade-in-up relative pl-8 border-l-2 border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono-code text-xs text-primary bg-primary/10 px-2 py-0.5 rounded inline-block", children: "Alliance Automotive Group" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold", children: "Technicien support niveau 1 / 2" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "text-muted-foreground leading-relaxed space-y-1 text-sm list-disc list-inside", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Administration Active Directory" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Support utilisateurs" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Logiciels métier" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Déploiement IT" })
        ] })
      ] })
    ] }) })
  ] }) });
    ...
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 pointer-events-none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/4 left-1/4 w-96 h-96 rounded-full bg-primary/5 blur-3xl" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-1/4 right-1/4 w-80 h-80 rounded-full bg-secondary/5 blur-3xl" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex flex-col items-center text-center gap-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full bg-primary/20 blur-xl scale-110" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-7xl md:text-9xl font-extrabold tracking-tight text-gradient-orange", children: "Dylan" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-lg md:text-xl text-muted-foreground max-w-xl leading-relaxed", children: [
              "Développeur passioné —",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: "je construis des trucs qui marchent" }),
              " ",
              "(et parfois qui explosent)"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-2", children: ["Python", "Java", "PHP", "Laravel", "React", "JavaFX"].map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              onClick: () => {
                var _a2;
                return (_a2 = document.getElementById("projets")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
              },
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium tracking-widest uppercase", children: "Voir mes projets" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ChevronDown,
                  {
                    className: "w-5 h-5",
...
const PROJECTS = [
  {
    title: "Puissance 4",
    tech: ["Python", "IA"],
    description: "Jeu de puissance 4 conçu de A à Z, en mode joueur contre joueur ou joueur contre IA (algorithme). Projet scolaire de Terminale réalisé en binôme.",
    github: "https://github.com/MNKY-dm/Puissance-4",
    image: "https://tse2.mm.bing.net/th/id/OIP.rYWvc2bEOQOADXa4LXz3FQHaFu?pid=Api"
  },
  {
    title: "Discord Clone",
    tech: ["PHP", "CRUD", "POO", "Git"],
    description: "Site web clone de Discord réalisé en groupe. Échange de messages dans des salons, avec gestion CRUD, programmation orientée objet et versioning Git.",
  ...
  },
  {
    ...
    description: "Application Java / JavaFX de billetterie : catalogue d'événements et achat de billets. Architecture MVC, CRUD complet, versioning Git.",
    github: "https://github.com/MNKY-dm/Teasy",
    image: "http://www.saintcyrsurmer.fr/fileadmin/Contenu/3_onglet_la_ville/1_decouvrez_saint_cyr_sur_mer/evenements_animations/ticket-01.jpg"
  },
  {
    title: "JavaFleet",
    tech: ["Java", "JavaFX", "MVC", "Git"],
    description: "Jeu de bataille navale en Java / JavaFX. Deux joueurs, sans IA. Architecture MVC, versioning Git.",
    github: "https://github.com/MNKY-dm/JavaFleet",
    image: "https://www.goodfreephotos.com/albums/historical-battles/american-revolution/naval-battle-between-french-and-british-at-chesapeake-bay-american-revolution.jpg"
  },
  {
    title: "Biblioteco",
    tech: ["Laravel", "PHP", "CRUD", "MVC", "Git"],
    description: "Site web de gestion de bibliothèque : emprunts et retours de livres, catalogue dynamique, rôles utilisateurs. CRUD, Eloquent ORM, architecture MVC, Git.",
...
const INTERESTS = [
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Gamepad2, { className: "w-7 h-7" }),
    label: "Jeux vidéo",
    reveal: "Outer Wilds m'a appris à explorer sans carte. RDR2 m'a montré qu'une histoire peut être plus vraie que la vraie vie.",
    color: "orange"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Film, { className: "w-7 h-7" }),
    label: "Cinéma",
    reveal: "Inception pour les couches, Spiderverse pour la forme. Le cinéma qui ose quelque chose, c'est le seul qui m'intéresse.",
    color: "green"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Cpu, { className: "w-7 h-7" }),
    label: "Tech",
    reveal: "macOS, iOS, l'écosystème Apple — et tout ce qui gravite autour. La tech comme outil, pas comme fin en soi.",
    color: "orange"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(PawPrint, { className: "w-7 h-7" }),
    label: "Animaux",
    reveal: "Comme dans Pokémon : chaque espèce mérite d'être observée, pas juste capturée.",
    color: "green"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { className: "w-7 h-7" }),
    label: "Géographie",
    reveal: "Les cartes me fascinent autant que les territoires. Comprendre où les choses se passent, c'est déjà comprendre pourquoi.",
    color: "orange"
  }
];
const SKILL_CATEGORIES = [
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CodeXml, { className: "w-5 h-5" }),
    label: "Langages",
    skills: [
      { name: "Python" },
      { name: "Java" },
  ...
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Cpu, { className: "w-5 h-5" }),
    label: "Frameworks",
    skills: [{ name: "Laravel" }, { name: "JavaFX" }]
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Wrench, { className: "w-5 h-5" }),
    label: "Outils",
    skills: [
      { name: "Git / GitHub" },
      { name: "VS Code" },
...
const NAV_ITEMS = [
  { id: "hero", label: "Accueil", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(House, { className: "w-4 h-4" }) },
  { id: "projets", label: "Projets", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FolderOpen, { className: "w-4 h-4" }) },
  { id: "interets", label: "Intérêts", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-4 h-4" }) },
  {
    id: "competences",
    label: "Compétences",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CodeXml, { className: "w-4 h-4" })
  },
  {
    id: "experience",
    label: "Expérience",
  ...
  { id: "veille", label: "Veille", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Rss, { className: "w-4 h-4" }) },
  {
    id: "contact",
    label: "Contact",
...
function InterestsSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "interets", className: "py-24 px-6 bg-card/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fade-in-up mb-16 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono-code text-xs text-green-nature tracking-widest uppercase mb-3 block", children: "// en dehors du code" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl md:text-5xl font-bold", children: "Ce qui me fait vibrer" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-4", children: INTERESTS.map((interest, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `absolute inset-0 transition-opacity duration-300 ${interest.color === "orange" ? "bg-primary/5" : "bg-secondary/5"} ${hovered === i ? "opacity-100" : "opacity-0"}`
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-lg font-semibold mb-2", children: interest.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: `text-sm text-muted-foreground leading-relaxed transition-all duration-300 overflow-hidden ${hovered === i ? "max-h-32 opacity-100" : "max-h-0 opacity-0"}`,
                children: interest.reveal
              }
            )
          ] })
        ]
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "nav",
      {
        ...
        children: NAV_ITEMS.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            ...
            title: item.label,
            className: `group relative flex items-center justify-center w-10 h-10 rounded-xl transition-all duration-200 ${active === item.id ? "bg-primary/80 text-primary-foreground" : "text-muted-foreground hover:bg-muted hover:text-foreground"}`,
            children: [
              item.icon,
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-14 bg-popover text-popover-foreground text-xs font-medium px-2 py-1 rounded-md whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none shadow-lg border border-border", children: item.label })
            ]
          },
          item.id
        ))
      ...
      "nav",
      {
        ...
        children: NAV_ITEMS.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            onClick: () => scrollTo(item.id),
            "aria-label": item.label,
            className: `flex flex-1 flex-col items-center gap-1 py-1 rounded-lg transition-colors ${active === item.id ? "text-primary" : "text-muted-foreground"}`,
            children: [
              item.icon,
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-medium leading-none", children: item.label })
            ]
          },
          item.id
        ))
...
function ProjectCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `card-hover rounded-2xl overflow-hidden border bg-card flex flex-col h-full ${featured ? "border-primary/30" : "border-border"}`,
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 flex flex-col flex-1 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold", children: project.title }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed flex-1", children: project.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href: project.github,
...
function ProjectsSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "projets", className: "py-24 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fade-in-up mb-16 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono-code text-xs text-primary tracking-widest uppercase mb-3 block", children: "// mes projets" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl md:text-5xl font-bold", children: "Ce que j’ai construit" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-stretch justify-center gap-3 md:gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3 overflow-hidden w-full max-w-4xl", children: [-1, 0, 1].map((offset) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `transition-all duration-500 flex-1 ${isCenter ? "scale-100 opacity-100" : "scale-95 opacity-40 hidden md:block"}`,
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProjectCard, { project, featured: isCenter })
          },
          `${idx}-${offset}`
        );
      }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center gap-2 mt-8", children: PROJECTS.map((project, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        onClick: () => setCurrent(i),
        "aria-label": `Aller au projet ${i + 1}`,
        className: `h-2 rounded-full transition-all duration-300 ${i === current ? "bg-primary w-6" : "bg-muted-foreground/40 w-2"}`
      },
      project.title
    )) })
  ] }) });
...
function SkillsSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "competences", className: "py-24 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fade-in-up mb-16 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono-code text-xs text-primary tracking-widest uppercase mb-3 block", children: "// ma boîte à outils" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl md:text-5xl font-bold", children: "Compétences" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: SKILL_CATEGORIES.map((cat, ci) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-xl bg-primary/15 flex items-center justify-center text-primary", children: cat.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-bold", children: cat.label })
          ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fade-in-up mt-10 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
...
function TechWatchSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "veille", className: "py-24 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fade-in-up mb-16 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono-code text-xs text-primary tracking-widest uppercase mb-3 block", children: "// ce que je lis en ce moment" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl md:text-5xl font-bold", children: "Veille techno" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-6", children: TECH_WATCH.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              variant: "outline",
              className: `text-xs font-mono-code ${item.color === "orange" ? "bg-primary/15 text-primary border-primary/30" : "bg-secondary/15 text-green-nature border-secondary/30"}`,
              children: item.tag
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold", children: item.title }),
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border py-8 px-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
    "© ",
    year,
    ". Built with",
    " ",
    /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "inline w-3.5 h-3.5 text-primary" }),
    " using",
    " ",
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "a",
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingNav, { active: activeSection }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "lg:pl-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(HeroSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ProjectsSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(InterestsSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SkillsSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ExperienceSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TechWatchSection, {}),
