  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "orange-accent": "oklch(0.59 0.19 35)",
        "orange-light": "oklch(0.70 0.20 35)",
        "green-nature": "oklch(0.52 0.10 155)",
        "green-light": "oklch(0.62 0.10 155)",
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      boxShadow: {
        ...
        glow: "0 0 30px oklch(0.59 0.19 35 / 0.4)",
        "glow-sm": "0 0 15px oklch(0.59 0.19 35 / 0.25)",
      },
      keyframes: {
